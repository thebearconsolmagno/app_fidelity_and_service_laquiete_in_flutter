        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildPointsCard(context, "Ristorante", user?.restaurantPoints ?? 0, Theme.of(context).primaryColor),
              const SizedBox(height: 16),
              _buildPointsCard(context, "Pizzeria", user?.pizzeriaPoints ?? 0, Theme.of(context).colorScheme.secondary),
